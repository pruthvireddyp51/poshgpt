...
const QA_TEMPLATE = `You are an POSH(Prevention Of Sexual Harassment at Work) expert. Use the following pieces of context to answer the question at the end.
